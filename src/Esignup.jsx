            ...
            <div className="w-1/2 flex items-center " >
                <div className="relative" >
                    <div className="absolute w-[75%] h-[95%] inset-5 backdrop-blur-sm bg-white/30 flex flex-col  gap-5 p-5" >
                        <p className="text-[#061FE4] text-[48px] font-semibold italic font-inter flex justify-center " >Sign up</p>
                        <p className=" text-[#061FE4] text-[26px] font-semibold italic font-inter flex justify-start ">Email</p>
                        ...
                        <p className=" text-[#061FE4] text-[26px] font-semibold italic font-inter flex justify-start ">Password</p>
                        ...
                        {/* <Link to="" className="pr-4 md:pl-40 font-roboto font-medium md:text-xl text-blue-600">Log In</Link> */}
                    </div>
